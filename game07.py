...
def carregar_imagen(nome, largura, altura):
    ...
    return pygame. transform.scale(imagen, (largura, altura))
...
objetivo = carregar_imagen("objetivo.png", 75, 75)
